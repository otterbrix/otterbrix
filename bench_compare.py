...
before = [75,  306, 262, 241,  211]   # синяя колонка
after  = [361,  454, 420,  72,  89]   # оранжевая колонка
us  =    [21,  467, 369,  77,  167]   # оранжевая колонка

unit = "ms"
title = "Время выполнения запросов (100к документов)"
legend_before = "duckdb"
legend_after  = "mongodb"
legend_us = "otterbrix"
# ─────────────────────────────────────────────────────────────────────────────
