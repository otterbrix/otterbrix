...
namespace components::catalog {
    ...
    //   'a' — auto:   maintained automatically (e.g. index→table); always auto-cascaded,
    //                 never blocks RESTRICT.
    //   'i' — internal: child is owned by the parent (e.g. constraint→table); always
    //                 auto-cascaded with the parent, never blocks RESTRICT.
    ...
    namespace deptype {
        ...
        // Only 'n' (normal) external dependencies block RESTRICT.
        // 'i' (internal) and 'a' (auto) dependencies are always auto-cascaded with the parent.
