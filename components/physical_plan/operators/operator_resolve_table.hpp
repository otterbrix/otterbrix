...
namespace components::operators {
    ...
    public:
        ...
        // pass — deepest-first, so a preceding resolve_namespace (its left in the
        // chain) commits and stamps its node BEFORE this resolve_table reads it,
        // exactly as the legacy left-first on_execute drive did. The async pg_class /
        // pg_attribute / pg_computed_column scan emits the column-schema chunk into
        // output_ and stamps namespace_oid_/table_oid_ onto target_node_;
        ...
        // on_execute + find_waiting_operator drive.
