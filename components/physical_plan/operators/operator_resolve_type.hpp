...
namespace components::operators {
    ...
    // emits the structural metadata for the matched row. Replaces the
    // catalog_view shortcut historically used by enrichment and the legacy
    // manager_disk_t::resolve_type path.
    //
    ...
    //   - Uses manager_disk_t::read_rows_by_key (pure storage primitive). No
    //     catalog_view, no dispatcher state.
