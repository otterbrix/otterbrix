...
namespace services::planner::impl {
    ...
    components::operators::operator_ptr create_plan_allocate_oids(const context_storage_t& context,
        ...
        const auto* n = static_cast<const components::logical_plan::node_allocate_oids_t*>(node.get());
        return boost::intrusive_ptr(
            new components::operators::operator_allocate_oids_t(context.resource, context.log.clone(), n->count()));
    }
