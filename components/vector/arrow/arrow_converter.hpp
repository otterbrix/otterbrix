...
namespace components::vector::arrow {
    ...
    void populate_arrow_table_schema(std::pmr::memory_resource* resource,arrow_table_schema_t& arrow_table, const ArrowSchema& arrow_schema);
    arrow_table_schema_t schema_from_arrow(std::pmr::memory_resource* resource, ArrowSchema* schema);
    data_chunk_t data_chunk_from_arrow(std::pmr::memory_resource* resource, ArrowArray* arrow_array,arrow_table_schema_t converted_schema);
