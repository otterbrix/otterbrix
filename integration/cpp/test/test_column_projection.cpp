...
TEST_CASE("integration::cpp::column_projection::disk_backed_projection") {
    auto config = make_test_config(test_temp_path("col_proj/disk_backed"), /*disk_on=*/true, /*wal_on=*/true);
...
TEST_CASE("integration::cpp::column_projection::disk_backed_join_and_group") {
    auto config = make_test_config(test_temp_path("col_proj/disk_backed_join"), /*disk_on=*/true, /*wal_on=*/true);
    test_spaces space(config);
    auto* dispatcher = space.dispatcher();
...
TEST_CASE("integration::cpp::column_projection::plain_select") {
    auto config = test_create_config(test_temp_path("col_proj/plain_select"));
...
TEST_CASE("integration::cpp::column_projection::select_with_where") {
    auto config = test_create_config(test_temp_path("col_proj/select_where"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::group_by") {
    auto config = test_create_config(test_temp_path("col_proj/group_by"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::inner_join") {
    auto config = test_create_config(test_temp_path("col_proj/inner_join"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::three_table_join") {
    auto config = test_create_config(test_temp_path("col_proj/three_table_join"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::subquery") {
    auto config = test_create_config(test_temp_path("col_proj/subquery"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::case_when") {
    auto config = test_create_config(test_temp_path("col_proj/case_when"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::order_by_non_select") {
    auto config = test_create_config(test_temp_path("col_proj/order_by"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::limit_does_not_break_projection") {
    auto config = test_create_config(test_temp_path("col_proj/limit"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::column_projection::empty_input_scalar_aggregate_guard") {
    auto config = make_test_config(test_temp_path("col_proj/empty_guard"), /*disk_on=*/true, /*wal_on=*/true);
    test_spaces space(config);
    auto* dispatcher = space.dispatcher();
