...
TEST_CASE("integration::cpp::test_instances") {
    auto config_works_1 = test_create_config(test_temp_path("test_instances/1"));
    auto config_works_2 = test_create_config(test_temp_path("test_instances/2"));
    auto config_works_3 = test_create_config(test_temp_path("test_instances/3"));
    auto config_failes_1 = test_create_config(test_temp_path("test_instances/1"));
    auto config_failes_2 = test_create_config(test_temp_path("test_instances/3"));
    // Use isolated test_instances/{1,2,3} subdirs so prior tests' artifacts in
