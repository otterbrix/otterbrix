...
TEST_CASE("integration::cpp::test_instances") {
    ...
    // Isolated per-process fixture paths avoid collisions with other tests' leftover
    // artifacts (e.g. test_persistence's WAL replays) in the shared working directory.
