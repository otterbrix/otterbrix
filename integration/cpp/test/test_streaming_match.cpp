...
TEST_CASE("integration::cpp::streaming_match::like_filter_streams_and_lands") {
    auto config = test_create_config(test_temp_path("test_streaming_match_like"));
...
TEST_CASE("integration::cpp::streaming_match::like_filter_with_limit_caps_across_batches") {
    auto config = test_create_config(test_temp_path("test_streaming_match_limit"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::having_count_filter_returns_correct_rows") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_having"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::join_with_nonpushdown_filter_returns_correct_rows") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_join_filter"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::delete_where_in_group_subquery_lands") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_delete_group"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::delete_using_large_build_side_does_not_overflow") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_delete_using_large"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::delete_using_with_nonpushdown_filter_lands") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_delete_using"));
    test_clear_directory(config);
    config.disk.on = false;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::like_all_null_element_disk_three_valued") {
    ...
    auto config = test_create_config(test_temp_path("test_streaming_match_like_all_null_disk"));
    test_clear_directory(config);
    config.disk.on = true;
    config.wal.on = false;
    test_spaces space(config);
...
TEST_CASE("integration::cpp::streaming_match::late_mat_gather_selective_disk_values_land") {
    auto config = test_create_config(test_temp_path("test_streaming_match_late_mat_gather"));
    test_clear_directory(config);
    config.disk.on = true;
    config.wal.on = false;
    test_spaces space(config);
