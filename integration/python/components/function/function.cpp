...
namespace components::function {
    ...
    bool table_function_data_t::equals(const function_data_t& /*other*/) const { return false; }

    simple_named_parameter_function_t::simple_named_parameter_function_t(
        std::string name_p,
    ...
    bool simple_named_parameter_function_t::has_named_parameters() const { return !named_parameters.empty(); }
} // namespace components::function
