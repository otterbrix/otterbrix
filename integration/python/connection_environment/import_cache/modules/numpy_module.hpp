...
namespace otterbrix {
    ...
    public:
        numpy_ma_cache_item_t(optional_ptr<python_import_cache_item_t> parent)
            : python_import_cache_item_t("ma", parent)
            , masked("masked", this) {}
    ...
    public:
        numpy_core_cache_item_t(optional_ptr<python_import_cache_item_t> parent)
            : python_import_cache_item_t("core", parent)
            , multiarray("multiarray", this) {}
    ...
    public:
        numpy_cache_item_t()
            : python_import_cache_item_t("numpy")
            , core(this)
            , ma(this)
            , ndarray("ndarray", this)
            , datetime64("datetime64", this)
            ...
            , half("half", this)
            , float16("float16", this)
            , single("single", this)
            , longdouble("longdouble", this)
            , csingle("csingle", this)
