...
bool try_transform_python_numeric(components::types::logical_value_t &res, py::handle ele,
...
core::result_wrapper_t<components::types::logical_value_t> transform_python_value(std::pmr::memory_resource *resource, py::handle ele,
        const components::types::complex_logical_type &target_type = components::types::logical_type::UNKNOWN,
