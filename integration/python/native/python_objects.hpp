...
namespace otterbrix {
    ...
    public:
        py::handle operator[](const py::object& obj) const { return PyDict_GetItem(dict.ptr(), obj.ptr()); }

    public:
        std::string to_string() const { return std::string(py::str(dict)); }
    ...
    struct py_decimal_t {
        ...
        public:
            ...
            static components::types::logical_value_t Operation(std::pmr::memory_resource* r,
                ...
                int64_t multiplier = POWERS_OF_TEN[std::min<uint8_t>(scale, CACHED_POWERS_OF_TEN - 1)];
    ...
    struct python_object_t {
        ...
        static core::result_wrapper_t<py::object> from_struct(std::pmr::memory_resource* r,
                                                              const components::types::logical_value_t& value,
                                                              const components::types::complex_logical_type& id);
        static core::result_wrapper_t<py::object> from_value(std::pmr::memory_resource* r,
                                                             const components::types::logical_value_t& value,
                                                             const components::types::complex_logical_type& id);
    };
    ...
    public:
        py_optional_t(const py::object& o)
            : py::object(o, borrowed_t{}) {}
        using py::object::object;

    public:
        static bool check_(const py::handle& object) { return object.is_none() || py::isinstance<T>(object); }
    };

    class file_like_object_t : public py::object {
    public:
        file_like_object_t(const py::object& o)
            : py::object(o, borrowed_t{}) {}
        using py::object::object;
