...
namespace otterbrix {
    ...
    pyexpr_ptr py_expression_t::column_expression(const std::string& column_name, py_connection_t& conn, const std::string& side) {
    ...
    void py_expression_t::print() const {
        py::print(to_string());
    }        
    

    // Aggregation operations
    pyexpr_ptr py_expression_t::count() {
        return aggregation_expression("count", *this);
    }

    pyexpr_ptr py_expression_t::sum() {
        return aggregation_expression("sum", *this);
    }

    pyexpr_ptr py_expression_t::min() {
        return aggregation_expression("min", *this);
    }

    pyexpr_ptr py_expression_t::max() {
        return aggregation_expression("max", *this);
    }

    pyexpr_ptr py_expression_t::avg() {
        return aggregation_expression("avg", *this);
    }

    pyexpr_ptr py_expression_t::round() {
        return scalar_unary_expression(expressions::scalar_type::round, *this);
    }

    pyexpr_ptr py_expression_t::ceil() {
        return scalar_unary_expression(expressions::scalar_type::ceil, *this);
    }

    pyexpr_ptr py_expression_t::floor() {
        return scalar_unary_expression(expressions::scalar_type::floor, *this);
    }

    pyexpr_ptr py_expression_t::abs() {
        return scalar_unary_expression(expressions::scalar_type::abs, *this);
    }
    ...
    pyexpr_ptr py_expression_t::ascending() {
        return sort_expression(expressions::sort_order::asc, *this);
    }

    pyexpr_ptr py_expression_t::descending() {
        return sort_expression(expressions::sort_order::desc, *this);
    }

    // Private methods


    const expression_wrapper_t& py_expression_t::get_expression() {
        return expr;
    }

    pyexpr_ptr py_expression_t::aggregation_expression(const std::string& function_name,
        const py_expression_t& expr) {
        return std::make_shared<py_expression_t>(
            unwrap(expr.factory->aggregation_unary_expression(function_name, expr.expr)), expr.factory);
    }
    ...
    pyexpr_ptr py_expression_t::scalar_binary_expression(components::expressions::scalar_type type,
        ...
        return std::make_shared<py_expression_t>(
            unwrap(left.factory->scalar_binary_expression(type, left.expr, right.expr)), left.factory);
    }
    ...
    pyexpr_ptr py_expression_t::comparison_expression(components::expressions::compare_type type,
        const py_expression_t& left, const py_expression_t& right) {
        return std::make_shared<py_expression_t>(
            unwrap(left.factory->comparison_expression(type, left.expr, right.expr)), left.factory);
    }
    ...
    pyexpr_ptr py_expression_t::comparison_union_expression(expressions::compare_type type,
            const py_expression_t& left, const py_expression_t& right) {
        return std::make_shared<py_expression_t>(
            unwrap(left.factory->comparison_union_expression(type, left.expr, right.expr)), left.factory);
    }
