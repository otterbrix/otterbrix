...
namespace otterbrix {
    ...
    static core::result_wrapper_t<complex_logical_type> from_object(const py::object& object,
        ...
        switch (object_type) {
            ...
            default: {
                ...
                return core::error_t(
                    core::error_code_t::conversion_failure,
                    std::pmr::string("Could not convert from object of type " + actual_type + " to OtterBrixPyType",
                                     resource));
            }
        }
    }
    ...
    std::string otterbrix_py_type_t::to_string() const { return logical_type_name(type_.type()); }
    ...
    const complex_logical_type& otterbrix_py_type_t::type() const { return type_; }
