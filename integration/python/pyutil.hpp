...
#pragma GCC diagnostic pop
        ...
        static idx_t PyUnicodeGetLength(py::handle& obj) { return static_cast<idx_t>(PyUnicode_GET_LENGTH(obj.ptr())); }

        static bool PyUnicodeIsCompact(PyCompactUnicodeObject* obj) { return PyUnicode_IS_COMPACT(obj); }
...
#pragma GCC diagnostic pop
        ...
        static int PyUnicodeKind(py::handle& obj) { return PyUnicode_KIND(obj.ptr()); }
