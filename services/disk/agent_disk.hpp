...
namespace services::disk {
    ...
    public:
        ...
        //   POSITION-ONLY index-resume: unlike storage_scan_batched_inner (which materializes the
        ...
        //   wrapper as a value (no throw across the mailbox), like scan_batched_local.
