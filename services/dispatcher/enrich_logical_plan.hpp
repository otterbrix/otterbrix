...
namespace services::dispatcher {
    ...
    // enrich_plan walks this map instead of probing catalog_view, so no async
    // catalog actor messages from validate/enrich/planner. Empty when the plan
    // has no resolve wrap (DDL paths, disk-less harnesses).
