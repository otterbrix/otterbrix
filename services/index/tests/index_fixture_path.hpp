...
namespace services::index::tests {
    ...
    inline void reclaim_dead_index_roots(const std::filesystem::path& shared, const std::filesystem::path& mine) {
    ...
    inline const std::filesystem::path& index_fixture_root() {
        static const std::filesystem::path root = [] {
            ...
            std::filesystem::path mine = shared / ("index_disk_" + std::to_string(static_cast<long>(::getpid())));
    ...
    inline std::filesystem::path index_fixture_path(std::string_view name) { return index_fixture_root() / name; }
